...
− becomes harder: review without a CHANGELOG entry (rejected outright);
  silent breaking changes (rejected by the policy); skipping the
  simultaneous five-crate 1.0 bump.
