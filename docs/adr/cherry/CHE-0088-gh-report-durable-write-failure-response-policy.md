...
Date: 2026-07-15
Last-reviewed: 2026-08-12 — refined — corrected R10 chokepoint citations (CHE-0048:R2 -> R7; dropped CHE-0029:R4) per GND-0007:R4
Tier: B
Status: Accepted
...
risks/migration: mission-03 implements `WriteOutcome`/`WritePolicyCategory` and rewires the five call sites; this ADR ratifies content only. Dead-letter wiring (CHE-0024:R5 schema) is deferred, tracked in bd bead ghr-6e32cd4f — not a response category here.
