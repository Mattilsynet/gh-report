...
//!
//! Algorithm: xxh3-128. Rationale: xxh3 is a fast non-cryptographic
//! hash; SHA-256 would be overkill for an integrity check (no
//! adversarial input — adr-srv reads its own corpus) and would cost
//! 16 extra bytes per event payload.
//!
//! Wire shape: 16-byte fixed-size array, encoded via msgpack.
