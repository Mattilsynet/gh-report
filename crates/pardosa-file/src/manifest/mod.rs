...
//! [ManifestFooter: 28 bytes]
//!   message_count [8] little-endian u64
//!   data_end [8]      little-endian u64
//!   checksum [8]      xxh64 over (header || records), little-endian
//!   magic [4]         = "PGIX"
//! ```
//!
//! Wire format frozen at version 1; pinned by
...
pub const MANIFEST_FOOTER_SIZE: usize = 28;
...
pub(super) const MANIFEST_FOOTER_CHECKSUM_OFFSET: usize = 16;
pub(super) const MANIFEST_FOOTER_MAGIC_OFFSET: usize = 24;
const _: () = assert!(
